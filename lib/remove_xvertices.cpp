...
void  remove_xvertices(LineTes *tes, double step){
  // replaces each X-vertex of "tes" by
 ...
 while (XVertices.size()>0){
  ...
  LineTes::Seg_handle new_s_tes=tes->insert_segment(new_s);
