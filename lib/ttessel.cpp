...
/** \brief Define the tessellation domain as a polygon without hole
 */
 ...
 *                 to e.
 * \param single_polygon : true if hpoly and hpoly_twin are the same holed
 ...
 * \param poly : reference polygon.
 * \return : a vector of Booleans, true for each tested hole
