...
Download (click the "Raw" button) the package source at https://github.com/kien-kieu/lite/blob/vx.y/build/wrap/R/RLiTe_x.y.tar.gz where x.y is the (latest) release number of LiTe.
